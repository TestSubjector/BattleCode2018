...
public class Player
{
    ...
    static long mapSize;
    static long earthPassableTerrain;
    ...
    */
    ...
    // TODO - Put these in Decision Tree , Note tLine Number 26 in PathFinder Player
    ...
    final static UnitType[] RESEARCH_QUEUE_HARD = {UnitType.Worker, UnitType.Ranger, UnitType.Ranger, UnitType.Rocket,
            UnitType.Healer, UnitType.Healer, UnitType.Rocket, UnitType.Worker, UnitType.Rocket,
    ...
    public static void initializeGlobals()
    {
        ...
        // Passable terrain count of earth
        earthPassableTerrain = 0;
        ...
        if (homePlanet == Planet.Earth)
        {
            ...
            for (int x = 0; x < mapWidth; x++)
            {
                ...
                {
                    long karboniteAtTempMapLocation;
                    ...
                    if(homeMap.isPassableTerrainAt(tempMapLocation) == 0)
                    {
                        ...
                        karboniteAtTempMapLocation = 0;
                    }
                    else
                    {
                        karboniteAtTempMapLocation = homeMap.initialKarboniteAt(tempMapLocation);
                    }
    ...
    */
    ...
    public static long maxFactoryLimitAtTurn(long currentRound, long totalCombatUnits)
    {
        ...
        {
            return Math.round(mapSize/100) + 1;
        }
    }
    */
    /*
    ...
    public static void main(String[] args)
    {
        ...
        */
        ...
        while (true)
        {
            ...
            // TODO - Send currentKarbonite and switchToPrimitive to Player

            long currentKarbonite = gc.karbonite();
                ...
                for (int ii = 0; ii < unitTypes.length; ii++)
                {
                    ...
                    for (int u = 0; u < unitList.size(); u++)
                    {
                        ...
                        if (!unitLocation.isInGarrison() && !unitLocation.isInSpace())
                        {
                            ...
                            {
                                boolean workerBuiltOrRepairedThisTurn = false;
                                ...
                                for (int j = 0; j < adjacentUnits.size(); j++)
                                {
                                    ...
                                    if (adjacentUnit.unitType() == UnitType.Factory || adjacentUnit.unitType() == UnitType.Rocket)
                                    {
                                        if (gc.canBuild(unit.id(), adjacentUnit.id()))
                                        {
                                            ...
                                            workerBuiltOrRepairedThisTurn = true;
                                            break;
                                        }
                                        else if(gc.canRepair(unit.id(), adjacentUnit.id()))
                                        {
                                ...
                                if (unitsOfType[UnitType.Factory.ordinal()] <= maxFactoryLimitAtTurn(currentRound, totalCombatUnitsOnTurn))
                                {
...
//                                }
                            ...
                            */
                            ...
                            if (unit.unitType() == UnitType.Ranger)
                            {
                                if (!unit.location().isInGarrison())
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            // So we really don't need UnitID here
                            ...
                            // TODO _ IGNORING MAGE AND KNIGHT CODE SINCE ITS JUST A COPY
                            /*
                            ...
                            */
                            ...
                            if (unit.unitType() == UnitType.Factory)
                            {
                                ...
                                // TODO  -  Add this check while processing unit
                                ...
                                // TODO - Push or break this to send to DecisionTree
